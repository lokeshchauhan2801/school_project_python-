...
class Annual_result:
    ...
    def fetch_data(self):
        ...
        self.cursor.execute(f"SELECT*FROM student_exam_details where(roll_no={roll_no}) ")
    ...
    def total(self):
        ...
        self.cursor.execute(f"SELECT sum(marks) FROM student_exam_details where(roll_no={roll_no})")
    ...
    def percentage(self):
        ...
        self.cursor.execute(f"SELECT sum(marks)/10 FROM student_exam_details where(roll_no={roll_no})")
